...
# Remplacer : duree_glissement_cible = max(1.5, temps_pour_distance)
duree_glissement_cible = 15.0
...
chemin_histoire_aire = f"{nom_doss}/histoire_aire_ta_{suff_temps_attente}.txt"
np.savetxt(chemin_histoire_aire, np.column_stack((temps, historique_A_reel)), header="temps A_reel")