...
# Force l'affichage des petits traits (ticks mineurs) sur l'axe X malgré la large plage log
...
ax_cloche.set_title("Évolution théorique du frottement en fonction de la vitesse (Matériau fractionnaire)", fontweight='bold')

# Grille uniquement sur les traits principaux (pas de lignes verticales pour les mineurs)
...
# Légende en gras
legend = ax_cloche.legend(loc='lower left', fontsize='small')
