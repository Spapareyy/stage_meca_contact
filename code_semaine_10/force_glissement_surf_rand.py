...
ax_fx.set(xlabel="Temps", ylabel="Force de frottement Ft",title=f"Frottement (surface aléatoire) (Pas = {pas}, N = {N}, vit= {v_cible}, pas_temps = {pas_temps:.4f}, phase pré-charg = {temps_attente})")
ax_fx.grid()
...
dossier_erreur = "resultat_erreur_tau_diff_rand_v_005"
